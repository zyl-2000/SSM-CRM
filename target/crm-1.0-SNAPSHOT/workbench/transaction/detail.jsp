...
<script type="text/javascript">
	...
	function TranhistoryList() {
		$.ajax({
			url:"workbench/transaction/historyListByTranId.do",
			data:{
	...
	function changeIcon(stage,i) {
		...
		var point = '<%=point%>';
		//如果当前阶段的可能性是0,说明前7个一定是黑圈,后两个分别是红叉或黑叉
		if ("0"==currentPossibility){
			...
			//当前阶段的可能性不是0,后两个一定是黑叉,前七个可能是绿标,绿圈,黑圈
		}else {
