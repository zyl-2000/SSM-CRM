...
<script type="text/javascript">
	...
	/*
	   关于阶段和可能性
	       ...
	       如果同时满足以上两种结论,那么我们将这样的数据保存到数据表中就没有意义了
	       如果遇到这种情况,我们需要用到properties属性文件来进行保存
	       stage2Possibility.properties
	       ...

	       注意:properties文件对中文的支持性很差,所以我们要将它转化为ascii码的形式
	           这里我们可以使用jdk自带的工具native2ascii.exe,将中文转变为ascii码
	...
	$(function () {
		...
		$("#create-stage").change(function () {
			...
			/*
			    目标:填写可能性
			    阶段有了stage
			    阶段和可能性之间的对应关系pMap,但是pMap是java语言中的键值队关系
			    我们首先得将pMap转换为js中键值对关系json
...
<body>
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" method="post" id="tranForm" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time2" id="create-expectedClosingDate" name="expectedDate" readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="a60deb77cab1468488623d47297ef1e8">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="638cdb18ff0e445699a5a44b773ca76f">
			</div>
		</div>
